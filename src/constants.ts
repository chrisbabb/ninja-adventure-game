...
export const STAGE_CONFIGS: Record<StageId, StageConfig> = {
  [StageId.HUGE_KNIGHT]: {
    ...
    enemies: [EnemyType.DWARF_WARRIOR, EnemyType.SKELETON_WARRIOR, EnemyType.STONE_GOLEM, EnemyType.GOBLIN, EnemyType.MASKED_ORC],
    tileColor: 0x556677,
    bgColor: 0x1a1a2e,
  ...
  [StageId.DEMON_BOSS]: {
    ...
    enemies: [EnemyType.IMP, EnemyType.PYROMANCER, EnemyType.SKELETON_MAGE, EnemyType.FLYING_EYE, EnemyType.POISON_SKULL],
    tileColor: 0x663322,
    bgColor: 0x1a0a0a,
  ...
  [StageId.HEADLESS_HORSEMAN]: {
    ...
    enemies: [EnemyType.WEREWOLF, EnemyType.GARGOYLE, EnemyType.SKELETON_WARRIOR, EnemyType.GOBLIN, EnemyType.HARPY],
    tileColor: 0x445566,
    bgColor: 0x0a0a1a,
    hasVineBarriers: false,
    hasBreakableBlocks: true,
  ...
  [StageId.WITCH]: {
    ...
    name: "Witch's Tower",
    boss: BossType.WITCH,
    enemies: [EnemyType.WIZARD, EnemyType.MIMIC_CHEST, EnemyType.POISON_SKULL, EnemyType.FLYING_EYE, EnemyType.BABY_DRAGON],
    tileColor: 0x554466,
    bgColor: 0x1a0a2a,
    hasVineBarriers: true,
    hasBreakableBlocks: false,
  ...
  [StageId.CERBERUS]: {
    ...
    enemies: [EnemyType.KOBOLD_WARRIOR, EnemyType.LIZARDMAN, EnemyType.SATYR_ARCHER, EnemyType.GRYPHON, EnemyType.WEREWOLF],
    tileColor: 0x665544,
    bgColor: 0x1a1a0a,
    hasVineBarriers: false,
    hasBreakableBlocks: true,
  ...
  [StageId.MEDUSA]: {
    ...
    enemies: [EnemyType.STONE_GOLEM, EnemyType.CYCLOPS, EnemyType.HARPY, EnemyType.GARGOYLE, EnemyType.LIZARDMAN],
    tileColor: 0x446655,
    bgColor: 0x0a1a1a,
    hasVineBarriers: false,
    hasBreakableBlocks: true,
  ...
  [StageId.DRAGON]: {
    ...
    enemies: [EnemyType.MINOTAUR, EnemyType.PYROMANCER, EnemyType.BABY_DRAGON, EnemyType.MASKED_ORC, EnemyType.STONE_GOLEM],
    tileColor: 0x664433,
    bgColor: 0x1a0a00,
    hasVineBarriers: true,
    hasBreakableBlocks: true,
